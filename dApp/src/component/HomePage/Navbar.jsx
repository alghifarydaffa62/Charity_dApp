            ...
            <div className="max-w-7xl mx-auto px-6 py-4">
                <div className="flex justify-around items-center">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <button onClick={() => window.location.href = '/charity'} className="cursor-pointer bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 px-6 py-2 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl">
                            Start Donating
                        </button>
                    </div>
                </div>
